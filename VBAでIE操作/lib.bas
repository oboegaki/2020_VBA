...
Sub IE_OPEN(targetURL As String, IE As InternetExplorerMedium)
    ...
    'https://stackoverflow.com/questions/12965032/excel-vba-controlling-ie-local-intranet
...
'別窓のIEをセット
'参考①https://vba-code.net/ie/open-link-in-new-tab/ ②http://kouten0430.hatenablog.com/entry/2018/08/11/150052
